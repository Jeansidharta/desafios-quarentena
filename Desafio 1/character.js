class Character {
	...
	/**
		...
		@argument { Type } type
		@argument { number } maxHealth
		@argument { Attack[] } attacks
		@argument { string } imgSource
		@argument { HTMLDivElement } containerElement
		@argument { HTMLParagraphElement } textElement
	*/
	...
	/** @argument { Attack } attack @argument { Character } character */
